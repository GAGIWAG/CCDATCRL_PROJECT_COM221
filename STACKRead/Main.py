...
# Side bar Frames
title_frame = customtkinter.CTkFrame(Main_app,width=150,height=Main_app.winfo_screenheight(),fg_color="#CCD5AE")
title_frame.place(x = -75, y = 0)

icon_frame = customtkinter.CTkFrame(Main_app,width=75,height=Main_app.winfo_screenheight(),fg_color="#CCD5AE")
...
label_title_home.place(x=window_width//2,y=0)
...
label_title_bookmark.place(x=window_width//2,y=0)
...
label_title_search.place(x=window_width//2,y=0)
...
label_title_library.place(x=window_width//2,y=0)


# Title and Icon Frame Content
button_stackread_img = customtkinter.CTkImage((Image.open("icons\stackreadicon.png")),size=(50,50))
button_stackread = customtkinter.CTkButton(icon_frame,image=button_stackread_img,text="",width=75,height=75,command=side_panel_switch,corner_radius=0,font=("Quando",16),fg_color="#CCD5AE")
button_stackread.place(x = 0, y = 0)

label_title = customtkinter.CTkLabel(title_frame, text="STACKRead",width=title_frame.winfo_width(),height=50,font=("Quando",14),fg_color="transparent",text_color="black")
...
button_home = customtkinter.CTkButton(icon_frame, image=button_home_img,text="", command=lambda: show_main_frame_content("Home"),width=75,height=75,corner_radius=0,fg_color="#CCD5AE")
button_home.place(x = 0 , y = 75)

button_bookmark_img = customtkinter.CTkImage((Image.open("icons\markbookunclicked.png")),size=(50,50))
button_bookmark = customtkinter.CTkButton(icon_frame,image=button_bookmark_img, text="", command=lambda: show_main_frame_content("Bookmark"),width=75,height=75,corner_radius=0,font=("Quando",16),fg_color="#CCD5AE")
button_bookmark.place(x = 0 , y = 150)

button_search_img = customtkinter.CTkImage((Image.open("icons\searchunclicked.png")),size=(50,50))
button_search = customtkinter.CTkButton(icon_frame,image=button_search_img, text="", command=lambda: show_main_frame_content("Search"),width=75,height=75,corner_radius=0,font=("Quando",16),fg_color="#CCD5AE")
button_search.place(x = 0 , y = 225)

button_library_img = customtkinter.CTkImage((Image.open("icons\libraryunclicked.png")),size=(50,50))
button_library = customtkinter.CTkButton(icon_frame,image=button_library_img, text="", command=lambda: show_main_frame_content("Library"),width=75,height=75,corner_radius=0,font=("Quando",16),fg_color="#CCD5AE")
...
button_label_home = customtkinter.CTkButton(title_frame, text="Home",command=lambda: show_main_frame_content("Home"),width=100,height=50,corner_radius=0,fg_color="transparent",font=("Quando",16),text_color="black")
button_label_home.place(x = 0 , y = 50)

button_label_bookmark = customtkinter.CTkButton(title_frame, text="BookMark", command=lambda: show_main_frame_content("BookMark"),width=100,height=50,corner_radius=0,fg_color="transparent",font=("Quando",16),text_color="black")
button_label_bookmark.place(x = 0 , y = 100)

button_label_search = customtkinter.CTkButton(title_frame, text="Search", command=lambda: show_main_frame_content("Search"),width=100,height=50,corner_radius=0,fg_color="transparent",font=("Quando",16),text_color="black")
button_label_search.place(x = 0 , y = 150)


button_label_library = customtkinter.CTkButton(title_frame, text="Library", command=lambda: show_main_frame_content("Library"),width=100,height=50,corner_radius=0,fg_color="transparent",font=("Quando",16),text_color="black")
button_label_library.place(x = 0 , y = 200)
